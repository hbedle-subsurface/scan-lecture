...
3. **Attributes.** Eighteen attributes, each with a choice of color scale,, including the amplitude of the full, near, mid and far stacks, overlaid on the seismic with fixed color scales.
