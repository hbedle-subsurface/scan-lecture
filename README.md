...
2. **Geologic setting.** Structural domains along the line (Roer Valley Graben, Peel Boundary Fault zone, Peel and Venlo blocks), five geologic events that each zoom to where they can be seen on SCAN029, formation groups shaded beside the wells, and an interpreted seismic line across the Californië wells from Doornenbal et al. (2019).
